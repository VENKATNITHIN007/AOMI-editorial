...
export function BecomePhotographerCTA() {
  return (
    <div className="relative bg-black text-white p-10 sm:p-16 rounded-[2.5rem] overflow-hidden group shadow-2xl">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
        <div className="space-y-6 max-w-lg">
          ...
          <h3 className="text-3xl sm:text-5xl font-thin uppercase tracking-tighter text-white leading-tight">
