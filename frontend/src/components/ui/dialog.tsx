...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("text-xl font-light tracking-wide text-black uppercase", className)}
      {...props}
    />
  )
}
...
function DialogDescription({
  ...
  return (
    <DialogPrimitive.Description
      ...
      className={cn("text-muted-foreground text-xs uppercase tracking-wider font-medium text-gray-500", className)}
      {...props}
    />
  )
}
